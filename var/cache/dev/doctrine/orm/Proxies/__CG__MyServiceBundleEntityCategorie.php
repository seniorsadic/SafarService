 ...
 */
class Categorie extends \MyServiceBundle\Entity\Categorie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MyServiceBundle\\Entity\\Categorie' . "\0" . 'idcategorie', '' . "\0" . 'MyServiceBundle\\Entity\\Categorie' . "\0" . 'designation'];
        }
