 ...
 */
class Ville extends \MyServiceBundle\Entity\Ville implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MyServiceBundle\\Entity\\Ville' . "\0" . 'idville', '' . "\0" . 'MyServiceBundle\\Entity\\Ville' . "\0" . 'designation'];
        }
