 ...
 */
class Roleutilisateur extends \MyServiceBundle\Entity\Roleutilisateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MyServiceBundle\\Entity\\Roleutilisateur' . "\0" . 'idroleuser', '' . "\0" . 'MyServiceBundle\\Entity\\Roleutilisateur' . "\0" . 'iduser', '' . "\0" . 'MyServiceBundle\\Entity\\Roleutilisateur' . "\0" . 'idrole'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Roleutilisateur $proxy) {
    ...
    public function getIdroleuser()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdroleuser();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdroleuser', []);

        return parent::getIdroleuser();
    }
