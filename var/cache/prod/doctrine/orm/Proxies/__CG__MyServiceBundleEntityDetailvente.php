 ...
 */
class Detailvente extends \MyServiceBundle\Entity\Detailvente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MyServiceBundle\\Entity\\Detailvente' . "\0" . 'iddetailvente', '' . "\0" . 'MyServiceBundle\\Entity\\Detailvente' . "\0" . 'quantite', '' . "\0" . 'MyServiceBundle\\Entity\\Detailvente' . "\0" . 'prixunitaire', '' . "\0" . 'MyServiceBundle\\Entity\\Detailvente' . "\0" . 'remise', '' . "\0" . 'MyServiceBundle\\Entity\\Detailvente' . "\0" . 'idvente', '' . "\0" . 'MyServiceBundle\\Entity\\Detailvente' . "\0" . 'idproduit'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Detailvente $proxy) {
