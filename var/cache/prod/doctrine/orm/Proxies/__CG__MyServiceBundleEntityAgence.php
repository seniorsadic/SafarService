 ...
 */
class Agence extends \MyServiceBundle\Entity\Agence implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MyServiceBundle\\Entity\\Agence' . "\0" . 'idagence', '' . "\0" . 'MyServiceBundle\\Entity\\Agence' . "\0" . 'designation', '' . "\0" . 'MyServiceBundle\\Entity\\Agence' . "\0" . 'idville'];
        }
