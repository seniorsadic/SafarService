 ...
 */
class Produit extends \MyServiceBundle\Entity\Produit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MyServiceBundle\\Entity\\Produit' . "\0" . 'idproduit', '' . "\0" . 'MyServiceBundle\\Entity\\Produit' . "\0" . 'designation', '' . "\0" . 'MyServiceBundle\\Entity\\Produit' . "\0" . 'quantite', '' . "\0" . 'MyServiceBundle\\Entity\\Produit' . "\0" . 'prix', '' . "\0" . 'MyServiceBundle\\Entity\\Produit' . "\0" . 'idagence', '' . "\0" . 'MyServiceBundle\\Entity\\Produit' . "\0" . 'idcategorie'];
        }
